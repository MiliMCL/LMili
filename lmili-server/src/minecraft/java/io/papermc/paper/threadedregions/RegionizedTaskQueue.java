...
public final class RegionizedTaskQueue {
    ...
    public PrioritisedExecutor.PrioritisedTask queueOrExecuteTickTask(final ServerLevel world, final int chunkX, final int chunkZ,
        ...
        return this.queueTickTaskQueue(world, chunkX, chunkZ, run, priority);
    }
    ...
    public static final class WorldRegionTaskData {
        ...
        private final ConcurrentChainedLong2ReferenceHashTable<RegionizedTaskQueue.ReferenceCountData> referenceCounters = new ConcurrentChainedLong2ReferenceHashTable<>();
