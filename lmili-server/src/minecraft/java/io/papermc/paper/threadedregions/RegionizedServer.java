...
public final class RegionizedServer {
    ...
    private void globalTick(final long tickCount) {
        ...
        // scheduler
        ((FoliaGlobalRegionScheduler)Bukkit.getGlobalRegionScheduler()).tick(); // Mili - revert to upstream scheduler impl: LMiliGlobalRegionScheduler was never wired into Bukkit API, cast would cause ClassCastException in global tick
