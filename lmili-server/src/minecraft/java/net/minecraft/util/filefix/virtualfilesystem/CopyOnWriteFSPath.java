...
public class CopyOnWriteFSPath implements Path {
    ...
    public boolean startsWith(final Path other) {
        ...
        return this.isAbsolute() == otherCow.isAbsolute() && this.path.startsWith(otherCow.path);
    }

    @Override
    public boolean endsWith(final Path other) {
        CopyOnWriteFSPath otherCow = asCow(other);
        return otherCow.isAbsolute() ? this.isAbsolute() && this.equals(otherCow) : this.path.endsWith(otherCow.path);
    }
