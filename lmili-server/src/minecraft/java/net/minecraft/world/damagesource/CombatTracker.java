...
public class CombatTracker {
    ...
    private Component getMessageForAssistedFall(
        ...
        ItemStack attackerItem = attackerEntity instanceof LivingEntity livingEntity && ca.spottedleaf.moonrise.common.util.TickThread.isTickThreadFor(livingEntity) ? livingEntity.getMainHandItem() : ItemStack.EMPTY; // Folia - region threading
