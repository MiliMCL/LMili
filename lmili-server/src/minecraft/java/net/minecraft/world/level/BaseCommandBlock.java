...
public abstract class BaseCommandBlock {
    ...
    public boolean performCommand(final ServerLevel level) {
        if (!fun.bm.mili.lmili.config.modules.experiment.CommandConfig.commandBlock) return false; // Folia - region threading // Luminol - Add experimental config for command block command execution
