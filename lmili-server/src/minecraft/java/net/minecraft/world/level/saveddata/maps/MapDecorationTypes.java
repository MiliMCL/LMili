...
public class MapDecorationTypes {
    ...
    public static final Holder<MapDecorationType> TRIAL_CHAMBERS = register("trial_chambers", "trial_chambers", true, COPPER_COLOR, false, true);
    ...
    private static Holder<MapDecorationType> register(final String name, final String assetName, final boolean showOnItemFrame, final boolean trackCount) {
        return register(name, assetName, showOnItemFrame, MapDecorationType.NO_MAP_COLOR, trackCount, false);
    }
