...
public abstract class TemplateSource {
    ...
    public static CompoundTag readStructure(final InputStream input) throws IOException {
    ...
    public StructureTemplate readStructure(final CompoundTag tag) {
        ...
        structureTemplate.load(this.blockLookup, ca.spottedleaf.dataconverter.minecraft.MCDataConverter.convertTag(ca.spottedleaf.dataconverter.minecraft.datatypes.MCTypeRegistry.STRUCTURE, tag, version, ca.spottedleaf.dataconverter.minecraft.util.Version.getCurrentVersion())); // Paper - rewrite dataconverter system
