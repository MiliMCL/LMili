...
public class LevelSummary implements Comparable<LevelSummary> {
    ...
    private Component createInfo() {
        ...
        MutableComponent result = this.isHardcore()
            ? Component.empty().append(Component.translatable("gameMode.hardcore").withColor(CommonColors.RED))
    ...
    public static class CorruptedLevelSummary extends LevelSummary {
        private static final Component INFO = Component.translatable("recover_world.warning").withStyle(style -> style.withColor(CommonColors.RED));
