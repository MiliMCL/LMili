            ...
            i -> i.group(i.present(MemoryModuleType.POTENTIAL_JOB_SITE), i.registered(MemoryModuleType.JOB_SITE))
                .apply(
                    ...
                    (potentialJobSite, jobSite) -> (level, body, timestamp) -> {
                        ...
                        jobSite.set(pos);
                        level.broadcastEntityEvent(body, EntityEvent.VILLAGER_HAPPY);
