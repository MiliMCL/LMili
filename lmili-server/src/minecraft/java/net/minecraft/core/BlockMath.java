...
public class BlockMath {
    private static final Map<Direction, Transformation> VANILLA_UV_TRANSFORM_LOCAL_TO_GLOBAL = Maps.newEnumMap(
        Map.of(
            ...
            Direction.EAST,
            new Transformation(null, new Quaternionf().rotateY(Mth.PI / 2.0F), null, null),
            Direction.WEST,
            new Transformation(null, new Quaternionf().rotateY(-Mth.PI / 2.0F), null, null),
            Direction.NORTH,
            new Transformation(null, new Quaternionf().rotateY(Mth.PI), null, null),
            Direction.UP,
            new Transformation(null, new Quaternionf().rotateX(-Mth.PI / 2.0F), null, null),
            Direction.DOWN,
            new Transformation(null, new Quaternionf().rotateX(Mth.PI / 2.0F), null, null)
        )
    );
