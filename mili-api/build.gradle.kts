...
sourceSets {
    main {
        java {
            ...
            srcDir(file("../lmili-api/src/main/java"))
            srcDir(file("src/main/java"))
        }
        resources {
            srcDir(file("../paper-api/src/main/resources"))
            srcDir(file("../folia-api/src/main/resources"))
            srcDir(file("../lmili-api/src/main/resources"))
    ...
    test {
        java {
            ...
            srcDir(file("../lmili-api/src/test/java"))
        }
        resources {
            srcDir(file("../paper-api/src/test/resources"))
            srcDir(file("../folia-api/src/test/resources"))
            srcDir(file("../lmili-api/src/test/resources"))
        }
    }
}
...
// LMili start - Hide unnecessary warnings
tasks.withType<JavaCompile> {
    val compilerArgs = options.compilerArgs
